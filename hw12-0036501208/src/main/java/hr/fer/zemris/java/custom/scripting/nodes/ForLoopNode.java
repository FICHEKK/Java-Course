...
public class ForLoopNode extends Node {
	...
	public ForLoopNode(ElementVariable var, Element start, Element end, Element step) {
		this.variable 		 = Objects.requireNonNull(var, "Variable cannot be null.");
		this.startExpression = Objects.requireNonNull(start, "Start cannot be null.");
		this.endExpression 	 = Objects.requireNonNull(end, "End cannot be null.");
