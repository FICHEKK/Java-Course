...
public class Prob1Test {
	...
	private void checkTokenStream(Lexer lexer, Token[] correctData) {
		...
		for(Token expected : correctData) {
			//System.out.println("Ex: " + expected.getValue().toString());
			//System.out.println("Ex: " + expected.getValue().toString().length());
			
			Token actual = lexer.nextToken();
			
			//System.out.println("Ac: " + actual.getValue().toString());
			//System.out.println("Ac: " + actual.getValue().toString().length());
