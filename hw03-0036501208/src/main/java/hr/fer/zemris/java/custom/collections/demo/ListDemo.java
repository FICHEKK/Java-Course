...
public class ListDemo {
	public static void main(String[] args) {
		...
		col1.get(0);
		col2.get(0);
		//col3.get(0); // neće se prevesti! Razumijete li zašto? Jer Collection "ne vidi" metodu List sučelja.
		//col4.get(0); // neće se prevesti! Razumijete li zašto? Jer Collection "ne vidi" metodu List sučelja.
