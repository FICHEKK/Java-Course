...
public class ArrayIndexedCollection implements List {
	...
	public ElementsGetter createElementsGetter() {
		return new ElementsGetterArrayList(this, modificationCount);
	}
	 ...
	 * was modified, it will throw exception.
	 */
	private static class ElementsGetterArrayList implements ElementsGetter {
		...
		private ElementsGetterArrayList(ArrayIndexedCollection collection, long modificationCount) {
		...
		public Object getNextElement() {
			if(hasNextElement()) {
				Object toBeReturned = collection.get(currentElementIndex);
				currentElementIndex++;
				return toBeReturned;
			} else {
