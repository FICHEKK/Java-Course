...
/**
 * A servlet that allows the user to download the band
...
public class GlasanjeXlsServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<Band> bands = (List<Band>) req.getSession().getAttribute("bandsWithVotes");
        HSSFWorkbook excelFile = generateExcelFile(bands);
